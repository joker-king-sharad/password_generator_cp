...
def print_cow():
    ...
    print(28 * " " + "[ sharad | https://github.com/joker-king-sharad]\r\n")


def version():
    """Display version"""

    print("\r\n	\033[1;31m[ cp.py ]  " + __version__ + "\033[1;m\r\n")
    print("	* Hacked up by Sharad - abcdfounded@gmail.com")
...
def improve_dictionary(file_to_open):
    ...
    if leetmode == "y":
        for (
            ...
            unique_lista
        ):  # if you want to add more leet chars, you will need to add more lines in cp.cfg too...
    ...
    print_to_file(file_to_open + ".cp.txt", unique_list_finished)
...
def main():
    ...
    read_config(os.path.join(os.path.dirname(os.path.realpath(__file__)), "cp.cfg"))
